...
where arguments that have not yet been described above are detailed here:
...
The SNPs in raf and corX must be in the same order and raf must be a named vector; corX may have column and row 
names as in this example, though this is not necessary. 
